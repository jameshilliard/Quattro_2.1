...
/* These symbols extracted/massaged from C-ctype.c from glibc 2.2.3 */
/* Could probably have been accomplished by a linker script or the --wrap option to ld 
   but I am not a particularly accomplished toolsmith */

#include <ctype.h>
 
const char __ctype_b_base_array[768] =
...
const unsigned short int *__ctype_b = ((const unsigned short int *)__ctype_b_base_array) + 128;

const __int32_t __ctype_toupper_base_array[384] = 
{
...
// indexes into the above array so can check ctype from -128 to 256
const __int32_t *__ctype_toupper = (const __int32_t *)__ctype_toupper_base_array + 128;

const __int32_t __ctype_tolower_base_array[384] = 
{
  /* 0x80 */ 0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87,
  /* 0x88 */ 0x88, 0x89, 0x8a, 0x8b, 0x8c, 0x8d, 0x8e, 0x8f,
  /* 0x90 */ 0x90, 0x91, 0x92, 0x93, 0x94, 0x95, 0x96, 0x97,
...
const __int32_t *__ctype_tolower = (const __int32_t *)__ctype_tolower_base_array + 128;
