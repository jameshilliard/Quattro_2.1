...
#define FFMPEG_CONFIGURATION "--arch=mips --enable-memalign-hack --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-mmi --disable-vhook --disable-network --disable-ipv6 --enable-fastdiv --enable-hardcoded-tables --disable-encoders --disable-decoders --disable-muxers --disable-demuxers --disable-parsers --disable-bsfs --disable-filters --disable-protocols --disable-indevs --disable-outdevs --disable-devices --enable-decoder=mpegaudio --enable-parser=mpegaudio --enable-bsf=mp3_header_decompress --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-decoder=mp1 --enable-decoder=mp2 --enable-decoder=mp3 --enable-protocol=file --enable-protocol=pipe --disable-debug"
