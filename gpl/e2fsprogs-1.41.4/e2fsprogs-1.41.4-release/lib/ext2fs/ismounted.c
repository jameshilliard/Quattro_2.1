 ...
 *
 * Copyright 2009 TiVo Inc. All Rights Reserved. Theodore Ts'o.
 *
 * %Begin-Header%
...
#define MOUNTED _PATH_MOUNTED
	...
	retval = check_mntent_file(MOUNTED, file, mount_flags, mtpt, mtlen);
        /*
         * On TiVo systems, if /proc/mounts exists and says that the filesystem
         * isn't mounted, and the /etc/mtab file doesn't exist, we can
         * believe that /proc/mounts is the Ultimate Truth and we should
         * not return an error
         */
        if (retval != 0 && procRetval == 0) {
            return 0;
        }
	return retval;
#else
