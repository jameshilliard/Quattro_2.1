...
#ifdef SWAP_ENDIAN
extern void ElfW(swap_Half);
extern void ElfW(swap_Word);
extern void ElfW(swap_SWord);
extern void ElfW(swap_Addr);
extern void ElfW(swap_Off);
extern void ElfW(swap_int);

extern void swap_kallsyms_hdr(struct kallsyms_header *);
extern void swap_kallsyms_sections(struct kallsyms_header *);
extern void swap_kallsyms_symbols(struct kallsyms_header *);
#endif
