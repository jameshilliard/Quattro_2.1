...
CONFIG_TIVO=y
# CONFIG_TIVO_DEVEL is not set
CONFIG_CONTIGMEM=y
# CONFIG_TIVO_MOJAVE is not set
# CONFIG_TIVO_NEUTRON is not set
# CONFIG_TIVO_GEN08 is not set
# CONFIG_TIVO_CONSDBG is not set
# CONFIG_TIVO_SATA_HOTPLUG is not set
# CONFIG_TIVO_WATCHDOG is not set
# CONFIG_TIVO_PLOG is not set
# CONFIG_TIVO_PANICLOG is not set
...
CONFIG_BRCM_MOCA=y
CONFIG_BRCM_USB=y
CONFIG_BRCM_OVERRIDE_USB=y
# CONFIG_BRCM_FORCE_USB_PWR_LO is not set
CONFIG_BRCM_FORCE_USB_PWR_HI=y
CONFIG_BRCM_FORCE_USB_OC_LO=y
# CONFIG_BRCM_FORCE_USB_OC_HI is not set
CONFIG_BRCM_USB_DISABLE_MASK=0x00
# CONFIG_BRCM_SDIO is not set
CONFIG_BRCM_PM=y
CONFIG_CSRC_WKTMR=y
...
CONFIG_BRCM_HAS_MOCA_20=y
CONFIG_BRCM_MOCA_VERS=0x2000
...
# CONFIG_SCSI_DOSECTORS is not set
