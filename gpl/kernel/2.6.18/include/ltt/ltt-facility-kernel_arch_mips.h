...
#include <ltt/ltt-facility-id-kernel_arch_mips.h>
...
enum lttng_syscall_name {
	...
	LTTNG_o32_splice = 4304,
	LTTNG_o32_sync_file_range = 4305,
	LTTNG_o32_tee = 4306,
	LTTNG_o32_vmsplice = 4307,
	LTTNG_o32_move_pages = 4308,
	LTTNG_o32_ltt_trace_generic = 4309,
	LTTNG_o32_ltt_register_generic = 4310,
	LTTNG_l64_base = 4999,
	LTTNG_l64_read = 5000,
	...
	LTTNG_l64_splice = 5263,
	LTTNG_l64_sync_file_range = 5264,
	LTTNG_l64_tee = 5265,
	LTTNG_l64_vmsplice = 5266,
	LTTNG_l64_move_pages = 5267,
	LTTNG_l64_ltt_trace_generic = 5268,
	LTTNG_l64_ltt_register_generic = 5269,
	LTTNG_N32_base = 5999,
	LTTNG_N32_read = 6000,
	...
	LTTNG_N32_splice = 6267,
	LTTNG_N32_sync_file_range = 6268,
	LTTNG_N32_tee = 6269,
	LTTNG_N32_vmsplice = 6270,
	LTTNG_N32_move_pages = 6271,
	LTTNG_N32_ltt_trace_generic = 6272,
	LTTNG_N32_ltt_register_generic = 6273,
};
	...
	list_for_each_entry_rcu(trace, &ltt_traces.head, list) {
		...
		*to_base = *to = *len = 0;
		...
		ltt_write_event_header(trace, channel, buffer,
			ltt_facility_kernel_arch_47814451, event_kernel_arch_syscall_entry,
		...
		void)
{
	...
	list_for_each_entry_rcu(trace, &ltt_traces.head, list) {
		...
		*to_base = *to = *len = 0;
		...
		ltt_write_event_header(trace, channel, buffer,
			ltt_facility_kernel_arch_47814451, event_kernel_arch_syscall_exit,
			reserve_size, before_hdr_pad, tsc);
		*to_base += before_hdr_pad + after_hdr_pad + header_size;
