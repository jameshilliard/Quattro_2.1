/*
 * Register defs for Broadcom BCM7401 host controller
 *
 * Copyright (C) 2006 TiVo, Inc. All Rights Reserved.
 */
#ifndef __ASM_BCM7401_H
#define __ASM_BCM7401_H
...
#define CPU_IRQ_INT0    2  /* CPU CP0_STATUS.IP[2] - GP 7401 h/w interrupt   */
#define CPU_IRQ_INT1    3  /* CPU CP0_STATUS.IP[3] - unused                  */
#define CPU_IRQ_INT2    4  /* CPU CP0_STATUS.IP[4] - unused                  */
#define CPU_IRQ_INT3    5  /* CPU CP0_STATUS.IP[5] - unused                  */
#define CPU_IRQ_INT4    6  /* CPU CP0_STATUS.IP[6] - 7401 Ethernet interrupt */
#define CPU_IRQ_INT5    7  /* CPU CP0_STATUS.IP[7] - Cycle Timer interrupt   */
