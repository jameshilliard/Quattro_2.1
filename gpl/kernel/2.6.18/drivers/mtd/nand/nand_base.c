...
#ifdef CONFIG_MTD_NAND_BUGON_WP
		printk(KERN_NOTICE "nand_write: "
		       "Attempt to write while write-protection is enabled\n");
                panic("Attempt to write while write-protection is enabled\n");
#else
		return -EIO;
#endif
        }
			     ...
			     struct mtd_oob_ops *ops)
{
	...
	if (nand_check_wp(mtd)){
#ifdef CONFIG_MTD_NAND_BUGON_WP
		printk(KERN_NOTICE "nand_write_oob: "
		       "Attempt to write while write-protection is enabled\n");
                panic("Attempt to write while write-protection is enabled\n");
#else
		return -EROFS;
...
#ifdef CONFIG_MTD_NAND_BUGON_WP
                panic("Attempt to erase while write-protection is enabled\n");
#else
