...
/* TDT breaks our mtd-utils */
	...
	case MTDMOJAVE:  
	{
		if (mtd->type != MTD_NORFLASH) return -EINVAL;
		extern int mojave_bbl(struct mtd_info *slave_mtd, int verify); 
		ret = mojave_bbl(mtd, arg);
		break;
	}    
#endif
