                ...
                
{
	switch (ch) {
		...
		case 0xb: 	/* CTRL-K breakpoint */
		   ...
		   goto goout;
#endif
#if defined(CONFIG_TIVO_CONSDBG) && defined(CONFIG_TIVO_NEUTRON)
extern void _do_async_dbg(struct pt_regs *regs, char ch);
extern int nodebug;
extern int dsscon;
...
#if defined(CONFIG_KGDB) || (defined(CONFIG_TIVO_CONSDBG) && defined(CONFIG_TIVO_NEUTRON))
goout:
	;
#endif
}
