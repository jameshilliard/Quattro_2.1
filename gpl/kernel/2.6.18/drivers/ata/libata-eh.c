			...
			if (rc == 0)
                        {
                                           ...
                                           || defined(CONFIG_TIVO_MOJAVE)))
//
// Moved set_xfermode until after read_id.  This allows for proper identification and avoids
// spinup unless the drive is properly identified and the drive conditions are properly evaluated.
//
				DPRINTK("calling spinup from eh\n");
