...
ENTROPIC_PCI_C_FILES +=                        \
  ../Common/Src/hostos_stubs.c                 \
  ../Common/Src/misc_driver_stubs.c            \
 
ENTROPIC_PCI_H_FILES +=                        \

ENTROPIC_PCI_INC_DIRS +=                       \

ENTROPIC_PCI_EXTRA_CFLAGS +=                   \

TARGET = pci-osnone
OBJ    = $(patsubst %.c, %.o, $(ENTROPIC_PCI_C_FILES))
LIBS   =

CXXFLAGS += $(ENTROPIC_COMMON_CFLAGS)
CXXFLAGS += $(ENTROPIC_PCI_EXTRA_CFLAGS)
CXXFLAGS += $(patsubst %, -I $(CURDIR)/%, $(ENTROPIC_PCI_INC_DIRS))
