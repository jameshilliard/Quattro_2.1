...
/*******************************************************************************
Change Log:
[10/31/08]	Kevin Cernekee		kcompat.h
		define the ZIP_2 macro, if user want compile a driver without the EN2210 support, then they can disable 
        the ZIP_2 and GMII_PROTO macros.
...
/*
 * define ZIP_2 if using this driver for a GMII board w/EN2210.
 * for normal gigabit ethernet operation, leave it undefined.
 * It is defined in Makefile
 */
/* #define ZIP_2 */

/*
 * define GMII_PROTO if using this driver for the GMII prototype board.
 * to support normal e1000 cards instead, leave it undefined.
 */
