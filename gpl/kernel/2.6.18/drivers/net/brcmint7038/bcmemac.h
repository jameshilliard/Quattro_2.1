...
typedef struct BcmEnet_devctrl {
   ...
   struct mii_if_info mii; /* structure that helps in parsing values used in ETHTOOL gets/sets over the MII bus */
#endif
#ifdef CONFIG_TIVO_NEUTRON
    void *p_dg_ctx;        /* Used by emoca driver */
#endif
} BcmEnet_devctrl;
