...
{
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_bcm_local_inv_rac_all;
	plog_flush_cache(flush_routine, (unsigned long)__builtin_return_address(0));
#endif
...
#else
    if (*((volatile unsigned long *)rac_config0) & 0x02)   /* skipping rac_config1 (TP1) check - bug 298345 */
#endif
	{
		unsigned long flags;
...
{
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_local_r4k_flush_cache_all;
	plog_flush_cache(flush_routine, (unsigned long)__builtin_return_address(0));
#endif
	r4k_blast_dcache();
	r4k_blast_icache();
...
static inline void local_r4k_flush_cache_range(void * args)
{
	...
	int exec;
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_local_r4k_flush_cache_range;
	plog_flush_cache(flush_routine,(unsigned long) __builtin_return_address(0));
#endif
	CACHE_ENTER(range);
...
void brcm_r4k_flush_cache_range(struct vm_area_struct *vma, unsigned long start, unsigned long end)
{
	...
	unsigned long flags;
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_brcm_r4k_flush_cache_range;
	plog_flush_cache(flush_routine,(unsigned long) __builtin_return_address(0));
#endif
	CACHE_ENTER(brange);
...
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_local_r4k_flush_cache_mm; 
	plog_flush_cache(flush_routine, (unsigned long)__builtin_return_address(0));
#endif
...
static inline void local_r4k_flush_cache_page(void *args)
{
	...
	pte_t *ptep;
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_local_r4k_flush_cache_page;
	plog_flush_cache(flush_routine, (unsigned long)__builtin_return_address(0));
#endif
...
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_local_r4k_flush_icache_range;
	plog_flush_cache(flush_routine,(unsigned long) __builtin_return_address(0));
#endif
...
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_local_r4k_flush_icache_page;
	plog_flush_cache(flush_routine,(unsigned long) __builtin_return_address(0));
#endif
	CACHE_ENTER(ipage);
...
{
#ifdef CONFIG_TIVO_PLOG
	dma_coh = f_r4k_dma_cache_wback_inv;
	plog_dma_coh(dma_coh, addr, size, (unsigned long)__builtin_return_address(0));
#endif
	CACHE_ENTER(dmawb);
...
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_local_r4k_flush_cache_sigtramp;
	plog_flush_cache(flush_routine,(unsigned long) __builtin_return_address(0));
#endif
...
{
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_r4k_flush_icache_all;
	plog_flush_cache(flush_routine,(unsigned long) __builtin_return_address(0));
#endif
	CACHE_ENTER(iflush);
...
static void r4k_flush_dcache_all(void)
{
#ifdef CONFIG_TIVO_PLOG
	flush_routine = f_r4k_flush_dcache_all;
	plog_flush_cache(flush_routine, (unsigned long)__builtin_return_address(0));
#endif
	CACHE_ENTER(dflush);
        r4k_blast_dcache();
...
/* RYH  5/19/06 */
	...
	flush_dcache_all	= r4k_flush_dcache_all;
