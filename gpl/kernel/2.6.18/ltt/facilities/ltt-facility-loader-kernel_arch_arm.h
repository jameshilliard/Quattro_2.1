...
ltt_facility_t	ltt_facility_kernel_arch_2B44F74C;

#define LTT_FACILITY_SYMBOL		ltt_facility_kernel_arch
#define LTT_FACILITY_CHECKSUM_SYMBOL	ltt_facility_kernel_arch_2B44F74C
#define LTT_FACILITY_CHECKSUM		0x2B44F74C
